...
func (m Model) keyHints() []keyHint {
	...
	case focusSidebar:
		return []keyHint{{"↑/↓", "move"}, {"space", "select agent"}, {"n", "next agent needing you"}, {"enter", "input"}, {"tab", "next section"}, {"esc", "back to input"}, {"ctrl+b", "close sidebar"}, {"pgup/pgdn", "scroll"}, {"ctrl+c", "quit"}}
	case focusMeta:
